...
很多框架都使用了 Java 的 SPI 机制，比如：Spring 框架、数据库加载驱动、日志接口、以及 Dubbo 的扩展实现。
...
![SPI区别去API](02-Java基础部分(下).assets/1706451157796.png)
...
![序列化图谱](02-Java基础部分(下).assets/1706451776760.png)
...
![OSI 七层协议模型](02-Java基础部分(下).assets/1706451851724.png)
...
序列化一般选择用Kryo  这个还没研究过，到时候深入了解一下，在上家公司使用的是这种形式。
